...
<form class="form-horizontal" method="post" action="/admin/snippet/new">
                    ...
                    <table class="table table-condensed form-table">
                        ...
                        <tfoot>
                            <tr class="form-group">
                                ...
                                <td>
                                    <div class="input-group col-xs-10">
                                        <button type="submit" class="btn btn-primary ajax_save" data-message="Snippet created." data-goto="/admin/snippet">Save</button>
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
